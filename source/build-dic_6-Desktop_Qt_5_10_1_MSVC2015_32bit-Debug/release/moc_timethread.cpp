...
void timethread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&timethread::sendtime)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject timethread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_timethread.data,
...
// SIGNAL 0
void timethread::sendtime(int _t1)
{
